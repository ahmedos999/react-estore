...
const Fav = (props) => {
    ...
    {props.Favdata && props.Favdata.map((Favdata)=>(
        ...
        <div className="btns">
            ...
            <button className='buy' onClick={(event)=>props.addItem(event,Favdata.name,Favdata.description,Favdata.price,Favdata.img,Favdata.id)}><BsCartPlus></BsCartPlus>Add To Cart</button>
        </div>
    </div>
    ))}
    </div>
